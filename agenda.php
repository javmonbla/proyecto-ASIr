...
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
    ...
    <title>Agenda <?php echo "$dia de $mes_titulo del $anio " ?></title>

<header style="background-color: rgb(27, 77, 124)">
<div class="d-flex justify-content-between p-2">
    <div class="me-2 d-flex align-items-center">
        <h2> <i class="bi bi-calendar"></i> <?php echo "$dia de $mes_titulo del $anio " ?></h2>
    </div>
    <div class="d-flex align-items-center mx-2">
        ...
        name="borrarsesion">
        <button class="mx-2 btn btn-outline-dark" name="borrar" type="submit">cerrar sesion</button>
        </form>
    </div>
</div>
</header>
